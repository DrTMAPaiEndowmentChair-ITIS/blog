...
The published system topology groups eight processors in a node with internal direct links. Nodes connect into a larger topology using a mix of electrical and optical paths.[^groq-isca] This is an architectural specification from the paper, not a claim that every deployed Groq service uses the same system generation.
