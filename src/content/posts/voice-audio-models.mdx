...
topics: ['Speech & audio', 'Multimodal', 'Architecture']
---
  ...
  stages={[
    ...
    },
    {
      ...
      details: [
        ...
        'Log-magnitude normalized to [-1, 1]',
        '80 channels (128 for large-v3)'
      ]
    },
    {
      id: 'conv',
      ...
      color: 'accent',
      details: [
        'Conv1D (3x3, stride 1) + GELU',
        'Conv1D (3x3, stride 2) + GELU',
        'Downsamples sequence by 2x'
      ]
    },
    {
      id: 'pos',
...
<BranchingFlow
  ...
  leftBranch={[{ id: 'content', label: 'Content Encoder', sublabel: '(narrow)', color: 'accent' }]}
  rightBranch={[{ id: 'speaker', label: 'Speaker Encoder', sublabel: '(narrow)', color: 'accent' }]}
  leftLabel="Content Path"
  rightLabel="Speaker Path"
  mergeNode={{
    id: 'replace',
    label: 'Replace Speaker Embedding',
    sublabel: 'Target speaker embedding',
    color: 'highlight'
  }}
  postMerge={[{ id: 'decoder', label: 'Decoder', color: 'accent' }]}
/>
...
<BranchingFlow
  ...
  outputLabel=""
  leftBranch={[{ id: 'w2v', label: 'w2v-BERT', sublabel: '(semantic)', color: 'accent' }]}
  rightBranch={[{ id: 'sound', label: 'SoundStream', sublabel: '(acoustic)', color: 'accent' }]}
  leftLabel="Semantic Path"
  rightLabel="Acoustic Path"
  mergeNode={{
    id: 'output',
    label: 'Semantic Tokens (coarse) + Acoustic Tokens RVQ (fine detail)',
    color: 'highlight'
  }}
/>
