...
description: 'Make local models faster and smaller with quantization, speculative decoding, attention optimization, caching, and runtime selection.'
topics: ['Edge & on-device', 'Quantization', 'LLM serving']
---
