...
The researchers identify such a set with the Jacobian lens. Their results support a functional workspace whose contents can be read and causally edited.[^1] The experiments do not address phenomenal consciousness.
...
The result connects three objects:
...
Counterfactual reports could also provide a supervision signal for changing internal computation.
