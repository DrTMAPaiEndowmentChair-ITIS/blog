...
topics: ['Training', 'Distributed training', 'Scaling laws']
---

import OptimizerStateComparison from '../../components/viz/OptimizerStateComparison.astro'
import OptimizerUpdateSequence from '../../components/viz/OptimizerUpdateSequence.astro'
