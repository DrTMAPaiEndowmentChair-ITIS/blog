...
description: 'Understand the Apple machine-learning stack from Metal and MPSGraph up to Core ML, and choose the right layer for the job.'
topics: ['Apple Silicon', 'Edge & on-device', 'Kernels']
---
