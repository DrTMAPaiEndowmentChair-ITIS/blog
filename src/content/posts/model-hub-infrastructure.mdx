...
The hub is good infrastructure: content addressing, chunk dedup, and resumable transfer are the right primitives. The mistake is treating it as a filesystem that happens to be remote instead of as a registry that happens to be public.
