...
topics: ['Reasoning', 'Mathematics', 'Verification', 'Evaluation']
---
...
The nine-author note — Alon, Bloom, Gowers, Litt, Sawin, Shankar, Tsimerman, Wang and Matchett Wood — appeared the same day, presenting "a short, digested, human-verified version" of the argument along with reflections on it.[^4] That is an extraordinarily strong referee panel assembled in under a day.
